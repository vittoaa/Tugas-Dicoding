...
# **Load Dataset**
@st.cache_data
def load_kotachangping():
    return pd.read_csv('PRSA_Data_Changping_20130301-20170228.csv')

# **Pilih jika ingin melihat detail perihal data Kota Changping**
st.subheader("Pilih jika ingin melihat detail perihal data Kota Changping")

changping_df = load_kotachangping()
